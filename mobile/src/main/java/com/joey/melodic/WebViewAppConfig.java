package com.joey.melodic;


import com.joey.melodic.BuildConfig;
...
public class WebViewAppConfig
{
	...
	public static final String ANALYTICS_TRACKING_ID = "UA-120128936-1";

	// unit ids for AdMob,
	// leave these constants empty if you do not want to use AdMob
	public static final String ADMOB_UNIT_ID_BANNER = "\n" +
			"ca-app-pub-2648520271685365/1293071072";
	public static final String ADMOB_UNIT_ID_INTERSTITIAL = "ca-app-pub-2648520271685365/4939552487";
